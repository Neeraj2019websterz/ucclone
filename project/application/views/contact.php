            ...
            <div class="col-12">
              <div class="row justify-content-center">
                <div class="col-md-7 text-center hero-text">
                  <h1 data-aos="fade-up" data-aos-delay="" class="aos-init aos-animate">Get in touch</h1>
        ...
        <div class="container">
          ...
          <div class="row justify-content-center text-center">
            <div class="col-md-7">
              ...
              <div class="owl-stage-outer"><div class="owl-stage" style="transition: all 1s ease 0s; width: 4445px; transform: translate3d(-1270px, 0px, 0px);"><div class="owl-item cloned" style="width: 635px;"><div class="review text-center">
                  <p class="stars">
                ...
                </div></div><div class="owl-item cloned" style="width: 635px;"><div class="review text-center">
                  <p class="stars">
                    <span class="icofont-star"></span>
                    <span class="icofont-star"></span>
                    <span class="icofont-star"></span>
                ...
                </div></div><div class="owl-item active center" style="width: 635px;"><div class="review text-center">
                  <p class="stars">
                    <span class="icofont-star"></span>
                    <span class="icofont-star"></span>
                    <span class="icofont-star"></span>
                ...
                </div></div><div class="owl-item" style="width: 635px;"><div class="review text-center">
                  <p class="stars">
                    <span class="icofont-star"></span>
                    <span class="icofont-star"></span>
                    <span class="icofont-star"></span>
